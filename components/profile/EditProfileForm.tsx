    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 pb-20">
      ...
      <div className="flex flex-col items-center mb-6">
        <div className="relative w-24 h-24 mb-3">
          ...
          <button
            type="button"
            className="absolute bottom-0 right-0 bg-white border border-gray-200 p-1.5 rounded-full text-gray-600 hover:text-[#329965] shadow-sm transition-colors"
          >
            <Camera size={14} />
          </button>
        </div>
      ...
      <div className="space-y-2">
        {" "}
        {/* Changed from space-y-1.5 to space-y-2 */}
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-3 mt-1">
          {" "}
          {/* Changed flex gap-6 to flex-wrap gap-3 for mobile */}
