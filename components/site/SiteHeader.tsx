      ...
      <div className="container mx-auto px-4">
          ...
          <div className="hidden md:flex flex-1 max-w-2xl items-center gap-3 px-4 lg:px-8">
            ...
            <div className="flex-1 bg-glass rounded-full p-[3px] flex items-center">
              ...
              <button className="h-[34px] px-5 bg-secondary hover:bg-orange-600 rounded-r-full text-white transition-colors flex items-center justify-center" suppressHydrationWarning={true}>
