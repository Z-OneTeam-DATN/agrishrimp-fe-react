...
export default function FloatingContactCluster() {
  ...
  const { isOpen: isChatOpen, openChat, setConsultProduct } = useChatStore();
  ...
  return (
    <div
      ref={containerRef}
      className="pointer-events-none fixed bottom-20 right-4 z-[60] md:bottom-8 md:right-8"
    >
      <div className="relative inline-flex flex-col items-end">
        <div
          aria-hidden={!open}
          className={cn(
            "pointer-events-none invisible absolute bottom-full right-0 mb-3 w-[min(340px,calc(100vw-2rem))] origin-bottom-right overflow-hidden rounded-[18px] border border-blue-100 bg-white shadow-2xl transition-all duration-200",
            open
        ...
        <button
          ...
          className="pointer-events-auto group flex h-16 items-center rounded-full bg-white pl-6 pr-2 text-blue-600 shadow-2xl ring-1 ring-blue-100 transition-transform hover:-translate-y-0.5 hover:text-blue-700"
        >
