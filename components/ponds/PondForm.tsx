      ...
      >
        ...
        <div className="space-y-2">
          ...
          <label className="text-sm font-bold text-gray-700">
            Tên ao nuôi <span className="text-red-500">*</span>
          </label>
          <input
            {...form.register("name")}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            {/* Changed from space-y-1.5 to space-y-2 */}
            <label className="text-sm font-bold text-gray-700">
              Độ sâu (m) <span className="text-red-500">*</span>
            </label>
            <input
              type="number"
              step="0.1"
        ...
        <div className="space-y-2">
          ...
          {/* Changed from space-y-1.5 to space-y-2 */}
          <label className="text-sm font-bold text-gray-700">
            Loài vật nuôi (Vụ hiện tại) <span className="text-red-500">*</span>
          </label>
          <input
          ...
          <p className="text-[11px] text-gray-400">
            Nhập tên loài đang thả nuôi hoặc dự kiến thả.
          </p>
        </div>
        {/* Trạng thái */}
        <div className="space-y-2">
