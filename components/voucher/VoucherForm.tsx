...
export default function VoucherForm({ onSubmit, isSubmitting = false }: VoucherFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="px-6 py-4 border-b border-gray-100 flex items-center gap-3 bg-gray-50">
        <Link href="/voucher" className="text-gray-500 hover:text-[#2d9f8d] transition-colors">
          <ChevronLeft size={24} />
        </Link>
