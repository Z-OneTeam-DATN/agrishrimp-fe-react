    ...
    <header className="h-[60px] border-b border-slate-200 bg-white/80 backdrop-blur-md flex items-center justify-between px-6 sticky top-0 z-50 shadow-sm">
      <div className="flex items-center gap-6 flex-1">
        ...
        <div className="flex items-center gap-3 pr-6 border-r border-slate-100">
          ...
          <div className="flex flex-col">
            <span className="text-[13px] font-black text-slate-900 leading-none tracking-tight">AGRISHRIMP CO.</span>
            <span className="text-[10px] font-bold text-blue-600 uppercase mt-0.5">Global Solutions</span>
          </div>
        </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden xl:flex items-center gap-2 px-3 py-1.5 bg-indigo-50 border border-indigo-100 rounded-full">
          ...
          <span className="text-[12px] font-bold text-indigo-700">Chi nhánh Hà Nội</span>
          <div className="w-1.5 h-1.5 bg-green-500 rounded-full animate-pulse ml-1" title="Online"></div>
        </div>

        {/* Utility Actions */}
        <div className="flex items-center gap-1 border-l border-slate-100 pl-4">
          <Button variant="ghost" size="icon" className="relative text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-colors">
            <Bell size={20} />
            <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-rose-500 rounded-full border-2 border-white"></span>
          </Button>
          
          <Button variant="ghost" size="icon" className="text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded-full transition-colors">
            <HelpCircle size={20} />
          </Button>
        </div>
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64 mt-3 shadow-2xl border-slate-100 rounded-xl p-2">
            <DropdownMenuLabel className="px-3 py-3">
              <div className="flex flex-col">
                <span className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Đang đăng nhập với</span>
