      ...
      <Table className="table-custom border-collapse min-w-[1000px]">
        <TableHeader>
          <TableRow className="bg-[#f0f0f0] hover:bg-[#f0f0f0] border-b border-[#ccc]">
            ...
            <TableHead className="font-bold text-[#1f1f1f] text-[11px] uppercase p-2">Tên vai trò & Phân nhóm</TableHead>
            <TableHead className="w-[180px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2 text-center">Phạm vi Module</TableHead>
            <TableHead className="w-[180px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2 text-center">Nhân sự áp dụng</TableHead>
            <TableHead className="w-[150px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2 text-center">Ngày tạo</TableHead>
        ...
        <TableBody>
          {roles.map((role) => (
            <TableRow key={role.id} className="hover:bg-[#f0f8ff] border-b border-[#eee] transition-colors">
              ...
              <TableCell className="text-[12px] font-bold text-slate-500 pl-4">#00{role.id}</TableCell>
              <TableCell className="p-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[13px] font-bold text-slate-800 uppercase tracking-tighter">{role.name}</span>
              ...
              <TableCell className="p-2 text-center">
                <span className="bg-slate-50 text-slate-500 border border-slate-200 px-2 py-0.5 rounded text-[10px] font-bold inline-flex items-center gap-1 uppercase tracking-tight">
                  <Shield size={10} className="text-emerald-500" /> {role.moduleCount} / 18 MODULE
                </span>
              </TableCell>
              <TableCell className="p-2 text-center">
                <div className="flex flex-col">
                  <span className="text-[13px] font-bold text-emerald-600">{role.activeCount} nhân viên</span>
                  <span className="text-[10px] text-slate-400 font-medium italic">Đang hoạt động</span>
                </div>
              </TableCell>
              <TableCell className="p-2 text-center">
                <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-500 font-medium">
                  <Calendar size={12} className="text-slate-300" /> {role.createdAt}
                </div>
              </TableCell>
