    ...
    <div className="w-full">
      <Table className="table-custom border-collapse">
        <TableHeader>
          <TableRow className="bg-[#f0f0f0] hover:bg-[#f0f0f0] border-b border-[#ccc]">
            ...
            <TableHead className="font-bold text-[#1f1f1f] text-[11px] uppercase p-2">Thông tin khách hàng & Tài khoản</TableHead>
            <TableHead className="w-[150px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2">Liên hệ</TableHead>
            <TableHead className="w-[150px] text-right font-bold text-[#1f1f1f] text-[11px] uppercase p-2">Chi tiêu (₫)</TableHead>
          ...
          {customers?.length > 0 ? (
            customers.map((cus) => (
              <TableRow 
                ...
                onClick={() => window.location.href = `/admin/customers/${cus.id}`}
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="text-[10px] text-slate-400 flex items-center gap-1 font-bold uppercase">
                        <MapPin size={10} /> {cus.addressDetail || "Chưa cập nhật địa chỉ"}
                      </span>
                    </div>
                  </div>
                </TableCell>
                ...
                <TableCell className="p-2 text-center font-bold text-slate-700 text-[12px]">0</TableCell>
            ...
            <TableRow>
              <TableCell colSpan={7} className="h-40 text-center">
                <div className="flex flex-col items-center justify-center gap-2">
                   <p className="text-[12px] text-slate-400 italic font-bold uppercase tracking-widest">Không có dữ liệu hiển thị</p>
                </div>
              </TableCell>
            </TableRow>
          )}
      ...
      <div className="flex items-center justify-between px-3 py-2 border-t border-[#eee] bg-[#f8f9fa]">
        ...
        <div className="flex items-center gap-1">
          ...
          <Button variant="outline" size="sm" className="h-6 w-6 p-0 text-[10px] bg-blue-600 text-white border-blue-600 font-bold shadow-sm">1</Button>
