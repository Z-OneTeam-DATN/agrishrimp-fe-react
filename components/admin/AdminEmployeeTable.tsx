      ...
      <Table className="table-custom border-collapse min-w-[1100px]">
        <TableHeader>
          <TableRow className="bg-[#f0f0f0] hover:bg-[#f0f0f0] border-b border-[#ccc]">
            ...
            <TableHead className="w-[220px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2">
              Liên hệ & Địa chỉ
            </TableHead>
            <TableHead className="w-[180px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2">
              Nơi công tác
            </TableHead>
            <TableHead className="w-[140px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2">
              Phân quyền
            </TableHead>
            <TableHead className="w-[110px] font-bold text-[#1f1f1f] text-[11px] uppercase p-2">
              Tài khoản
            </TableHead>
