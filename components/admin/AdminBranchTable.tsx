  ...
  return (
    <div className="w-full">
      <Table className="table-custom border-collapse min-w-[1100px]">
        ...
        <TableBody>
          {branches.map((branch) => (
            <TableRow key={branch.id} className="hover:bg-[#f0f8ff] border-b border-[#eee] transition-colors cursor-pointer">
              ...
              <TableCell className="p-2">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[13px] font-bold text-slate-800 uppercase tracking-tight">{branch.name}</span>
