      ...
      <div className="flex-1 overflow-y-auto px-4 space-y-6 no-scrollbar">
        ...
        <section>
          ...
          <div className="space-y-0.5">
            ...
            <SidebarLink href="/admin/customers" icon={Users} label="Khách hàng hộ nuôi" active={isActive("/admin/customers")} badge={150} />
        ...
        <section>
          ...
          <div className="space-y-0.5">
            <SidebarLink href="/admin/branches" icon={Building2} label="Chi nhánh" active={isActive("/admin/branches")} />
