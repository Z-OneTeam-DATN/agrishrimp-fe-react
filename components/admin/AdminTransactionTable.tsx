    ...
    <div className="w-full">
        ...
        <Table className="table-custom border-collapse">
          <TableHeader>
            <TableRow className="bg-[#f0f0f0] hover:bg-[#f0f0f0] border-b border-[#ccc]">
              <TableHead className="w-[100px] font-bold text-[#1f1f1f] text-[10px] uppercase p-2 pl-4">
                Mã GD
              </TableHead>
              <TableHead className="w-[150px] font-bold text-[#1f1f1f] text-[10px] uppercase p-2">
                Thời gian
              </TableHead>
              <TableHead className="font-bold text-[#1f1f1f] text-[10px] uppercase p-2">
                Nội dung giao dịch
              </TableHead>
              <TableHead className="w-[150px] font-bold text-[#1f1f1f] text-[10px] uppercase p-2">
                Đối tượng
              </TableHead>
              <TableHead className="w-[150px] text-right font-bold text-[#1f1f1f] text-[10px] uppercase p-2">
                Số tiền (₫)
              </TableHead>
              <TableHead className="w-[120px] text-center font-bold text-[#1f1f1f] text-[10px] uppercase p-2 pr-4">
                Trạng thái
              </TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {transactions.map((item: any, idx: any) => (
              <TableRow
                key={idx}
                className="hover:bg-[#f0f8ff] border-b border-[#eee] last:border-0 transition-colors"
              >
                <TableCell className="p-2 pl-4 text-slate-400 font-mono text-[11px]">
                  #{item.id}
                </TableCell>
                <TableCell className="p-2 text-[11px] text-slate-500 font-medium">
                  {item.date}
                </TableCell>
                <TableCell className="p-2 text-[12px] font-bold text-slate-800">
                  {item.note}
                </TableCell>
                <TableCell className="p-2 text-[11px] text-slate-400 font-black uppercase">
                  {item.target}
                </TableCell>
                <TableCell
                  className={cn(
      ...
      <div className="flex items-center justify-between px-3 py-2 border-t border-[#eee] bg-[#f8f9fa]">
        <p className="text-[10px] text-gray-400 font-bold uppercase">
          Phát sinh trong kỳ: {transactions.length} giao dịch
        </p>
