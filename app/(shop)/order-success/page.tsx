  ...
  const hero = useMemo(() => {
    if (paymentState === "FAILED") {
      return {
        ...
        description:
          "Hệ thống chưa ghi nhận giao dịch thành công. Bạn có thể mở lại đơn hàng để kiểm tra hoặc thanh toán lại.",
    ...
    if (paymentState === "PENDING") {
      return {
        ...
        description:
          "AgriShrimp đã tiếp nhận yêu cầu của bạn. Trạng thái thanh toán sẽ được cập nhật trong trang đơn hàng.",
    ...
    return {
      ...
      description: "Đơn hàng của bạn đã được ghi nhận. Bạn có thể theo dõi chi tiết trong trang đơn hàng.",
