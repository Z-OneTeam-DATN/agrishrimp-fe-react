  ...
  return (
    <div className="bg-[#f8f9fa] min-h-screen pb-10 font-sans text-gray-800">
      ...
      <div className="lg:hidden flex items-center justify-between p-4 bg-white border-b border-gray-100 shadow-sm sticky top-0 z-10">
        <Link href="/profile" className="text-gray-600 hover:text-gray-800 p-1 -ml-1">
          <ChevronLeft size={24} />
        </Link>
      ...
      <div className="lg:container lg:mx-auto px-4 py-4 lg:px-4 lg:py-6"> {/* Adjusted padding */}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 min-h-[600px]">
            ...
            <div className="flex justify-between items-center p-5 border-b border-gray-100">
                ...
                <Link href="/ai-doctor">
                    <button className="bg-[#329965] hover:bg-[#268050] text-white px-4 h-12 rounded-md text-sm font-bold flex items-center gap-2 transition-colors shadow-sm"> {/* h-12 */}
                ...
                <div className="space-y-4">
                    {filteredHistory.length > 0 ? (
                        ...
                        <div key={item.id} className="border border-gray-200 rounded-lg p-4 flex flex-col md:flex-row gap-4 items-start hover:border-[#329965] transition-colors bg-white group">
                            ...
                            {/* Image */}
                            <div className="relative w-full md:w-20 h-20 shrink-0 rounded-md overflow-hidden bg-gray-100 border border-gray-100"> {/* h-20 */}
                                <Image 
                                    src={item.imageUrl} 
                                    alt={item.diagnosis} 
                                    fill 
                            ...
                            <div className="w-full md:w-auto mt-2 md:mt-0 flex flex-col justify-center h-full">
                                <Link href={`/ai-doctor/result?id=${item.id}`}>
                                    <button className="w-full md:w-auto px-4 h-12 border border-[#329965] text-[#329965] hover:bg-[#eaf7f4] rounded-md text-xs font-bold transition-colors flex items-center justify-center gap-1 whitespace-nowrap"> {/* h-12 */}
