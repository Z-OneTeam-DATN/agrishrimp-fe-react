...
import { 
  ...
  CreditCard, Percent, FileText, Camera, 
  Briefcase, BadgeCheck, Landmark, Upload
} from "lucide-react";
...
export default function AddDealerPage() {
  ...
  const handleLicenseChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => setLicensePreview(event.target?.result as string);
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-9 space-y-3">
          ...
          <div className="bg-white border border-[#dcdcdc] p-[15px_20px] rounded-[4px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              <div className="md:col-span-2 space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Tên doanh nghiệp / Tên đại lý <span className="text-red-500">*</span></Label>
                <Input placeholder="Ví dụ: Công ty TNHH Thủy Sản Agri Miền Tây..." className="h-[32px] text-[13px] border-[#ccc] rounded-[3px] focus-visible:ring-emerald-500/20 shadow-none font-bold" />
              </div>
              <div className="space-y-[2px]">
                ...
                <Input placeholder="Nhập mã số thuế..." className="h-[32px] text-[13px] border-[#ccc] rounded-[3px] shadow-none font-mono" />
              </div>
              <div className="space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Loại hình đại lý</Label>
                <Select defaultValue="lv1">
                  ...
                  <SelectContent>
                    <SelectItem value="lv1">Đại lý Cấp 1 (Tổng phân phối)</SelectItem>
                    <SelectItem value="lv2">Đại lý Cấp 2</SelectItem>
                    <SelectItem value="farm">Hộ nuôi lớn (Key Account)</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
          ...
          <div className="bg-white border border-[#dcdcdc] p-[15px_20px] rounded-[4px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-4">
              <div className="space-y-[2px]">
                ...
                <Input placeholder="Người đại diện pháp luật..." className="h-[32px] text-[13px] border-[#ccc] rounded-[3px] shadow-none" />
              </div>
              <div className="space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Chức vụ</Label>
                <div className="relative">
                  <Briefcase className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-300" size={14} />
                  <Input placeholder="Chủ đại lý, Giám đốc..." className="h-[32px] pl-8 text-[13px] border-[#ccc] rounded-[3px] shadow-none" />
                </div>
              </div>
              <div className="space-y-[2px]">
                ...
                <div className="relative">
                  <Phone className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-300" size={14} />
          ...
          <div className="bg-white border border-[#dcdcdc] p-[15px_20px] rounded-[4px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-4">
              <div className="space-y-[2px]">
                ...
                <Select><SelectTrigger className="h-[32px] text-[12px] border-[#ccc] rounded-[3px] shadow-none"><SelectValue placeholder="Chọn Tỉnh/TP" /></SelectTrigger><SelectContent><SelectItem value="ct">Cần Thơ</SelectItem></SelectContent></Select>
              </div>
              <div className="space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Quận / Huyện</Label>
                <Select><SelectTrigger className="h-[32px] text-[12px] border-[#ccc] rounded-[3px] shadow-none"><SelectValue placeholder="Chọn Quận/Huyện" /></SelectTrigger><SelectContent><SelectItem value="nk">Ninh Kiều</SelectItem></SelectContent></Select>
              </div>
              <div className="space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Phường / Xã</Label>
                <Select><SelectTrigger className="h-[32px] text-[12px] border-[#ccc] rounded-[3px] shadow-none"><SelectValue placeholder="Chọn Phường/Xã" /></SelectTrigger><SelectContent><SelectItem value="xk">Xuân Khánh</SelectItem></SelectContent></Select>
              </div>
              <div className="md:col-span-3 space-y-[2px]">
                ...
                <Input placeholder="Nhập địa chỉ đầy đủ..." className="h-[32px] text-[13px] border-[#ccc] rounded-[3px] shadow-none" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#dcdcdc] p-[15px_20px] rounded-[4px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-4">
              <div className="space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Hạn mức công nợ (VNĐ)</Label>
                <div className="relative">
                  <CreditCard className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-300" size={14} />
                  <Input type="number" defaultValue={0} className="h-[32px] pl-8 text-[13px] border-[#ccc] rounded-[3px] shadow-none text-right font-bold" />
                </div>
              </div>
              <div className="space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Mức chiết khấu (%)</Label>
                <div className="relative">
                  <Percent className="absolute left-2 top-1/2 -translate-y-1/2 text-slate-300" size={14} />
                  <Input type="number" defaultValue={0} className="h-[32px] pl-8 text-[13px] border-[#ccc] rounded-[3px] shadow-none text-right font-bold text-emerald-600" />
                </div>
              </div>
              <div className="space-y-[2px]">
                <Label className="text-[11px] font-bold text-slate-500 uppercase tracking-tighter">Tài khoản ngân hàng</Label>
                <Input placeholder="Số tài khoản - Ngân hàng..." className="h-[32px] text-[13px] border-[#ccc] rounded-[3px] shadow-none" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-3 space-y-3">
          ...
          <div className="bg-white border border-[#dcdcdc] p-[15px_20px] rounded-[4px] shadow-[0_1px_2px_rgba(0,0,0,0.05)] text-center">
            <Label className="text-[11px] font-bold text-slate-500 uppercase block mb-4 tracking-widest">Giấy phép kinh doanh</Label>
            <div 
            ...
            >
              {licensePreview ? (
                <img src={licensePreview} alt="License" className="w-full h-full object-contain p-2" />
              ) : (
                <div className="text-center">
                  <Upload size={24} className="text-slate-200 mx-auto mb-1" />
                  <span className="text-[9px] font-bold text-slate-400 uppercase tracking-tighter">Tải ảnh giấy phép</span>
                </div>
              )}
              <input type="file" ref={licenseRef} onChange={handleLicenseChange} hidden accept="image/*" />
            </div>
          ...
          {/* Business Status */}
          <div className="bg-white border border-[#dcdcdc] p-[15px_20px] rounded-[4px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            <Label className="text-[11px] font-bold text-slate-500 uppercase block mb-3 tracking-widest">Trạng thái hợp tác</Label>
          ...
          {/* Assigned Staff */}
          <div className="bg-white border border-[#dcdcdc] p-[15px_20px] rounded-[4px] shadow-[0_1px_2px_rgba(0,0,0,0.05)]">
            <Label className="text-[11px] font-bold text-slate-500 uppercase block mb-3 tracking-widest">Nhân viên quản lý</Label>
