  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
        <div className="lg:col-span-9 space-y-5">
          ...
          <div className="bg-white border border-[#dcdcdc] p-6 rounded-none shadow-sm">
            ...
            <RichTextEditor
              minHeight="250px"
              placeholder="Nhập nội dung mô tả chi tiết cho sản phẩm tại đây..."
            />
          </div>
          ...
          <div className="bg-white border border-[#dcdcdc] rounded-none shadow-sm overflow-hidden">
            <div className="px-[20px] py-[12px] border-b border-[#eee] bg-[#f8f9fa] flex justify-between items-center">
              <h3 className="text-[11px] font-black text-slate-700 flex items-center gap-2 uppercase tracking-wider whitespace-nowrap">
                <Layers size={16} className="text-emerald-600" /> 3. Danh sách
              ...
              {fields.map((field, idx) => {
                ...
                return (
                  <div
                    key={field.id}
                    className={cn(
                      "overflow-hidden transition-colors border-b last:border-b-0",
                      ...
                      <div className="flex flex-col xl:flex-row gap-8">
                        ...
                        <div className="flex flex-col items-center shrink-0">
                          ...
                          <input
                            ...
                            accept="image/*"
                          />
                          <p className="text-[9px] font-black text-slate-400 mt-2 uppercase tracking-tighter whitespace-nowrap text-center">
                            Ảnh SKU #{idx + 1}
                          </p>
                          {rowError?.image && (
                        ...
                        <div className="flex-1 space-y-6">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div className="space-y-1.5">
                              <Label className="text-[10px] font-black text-slate-500 uppercase tracking-tight whitespace-nowrap">
                                Dạng bào chế *
                              </Label>
                              <div className="flex gap-0">
                                <Input
                                  ...
                                  placeholder=""
                                  className="h-[34px] border-[#ccc] rounded-none focus:border-emerald-500 focus:ring-0 text-[13px] shadow-none w-full"
                                />
                                <DropdownMenu>
                                  <DropdownMenuTrigger asChild>
                                    <Button
                                      variant="outline"
                                      className="h-[34px] w-[34px] p-0 border-[#ccc] border-l-0 rounded-none bg-[#f8f9fa] hover:bg-emerald-50"
                                    >
                                      <ChevronDown
                                        size={14}
                                  ...
                                  >
                                    {FORMULATION_SUGGESTIONS.map((i) => (
                                      <DropdownMenuItem
                                        key={i}
                                        onSelect={() =>
                                          setValue(
                                            `variants.${idx}.formulation`,
                                            i,
                                            { shouldValidate: true },
                                          )
                                        }
                              ...
                              <div className="flex gap-0">
                                ...
                                <DropdownMenu>
                                  ...
                                  <DropdownMenuContent
                                    ...
                                    className="rounded-none"
                                  >
                                    {PACKAGING_SUGGESTIONS.map((i) => (
                                      <DropdownMenuItem
                                        key={i}
                                        onSelect={() =>
                                          setValue(
                                            `variants.${idx}.packaging`,
                                            i,
                                            { shouldValidate: true },
                                          )
                                        }
                            ...
                            <div className="space-y-1.5">
                              ...
                              <Input
                                ...
                                placeholder=""
                                className="h-[34px] border-[#ccc] rounded-none text-[13px] shadow-none"
                              />
                              {rowError?.unit && (
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
                            ...
                            <div className="space-y-1.5">
                              <Label className="text-[10px] font-black text-transparent select-none uppercase tracking-tight whitespace-nowrap">
                                Thao tác
                              </Label>
                              <div className="flex items-center justify-between bg-slate-100/50 p-1 px-4 border border-dashed border-slate-300 h-[34px]">
                                <button
                                  ...
                                  className="flex items-center gap-2 text-[10px] font-black text-slate-600 hover:text-blue-600 transition-colors uppercase tracking-tight whitespace-nowrap"
                                >
                                  <Settings2 size={14} />{" "}
                                  {isExpanded ? "Đóng Spec" : "Cấu hình Spec"}
                                </button>
                                <button
                                  type="button"
                                  onClick={() => remove(idx)}
                                  className="flex items-center gap-2 text-[10px] font-black text-slate-400 hover:text-rose-500 transition-colors uppercase tracking-tight whitespace-nowrap"
                                >
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                            <div className="space-y-1.5">
                              <Label className="text-[10px] font-black text-blue-600 uppercase tracking-tight whitespace-nowrap">
                              ...
                              {rowError?.costPrice && (
                                <p className="text-[9px] text-red-500 font-bold">
                                  {rowError.costPrice.message}
                                </p>
                              )}
                            </div>

                            <div className="space-y-1.5">
                              <Label className="text-[10px] font-black text-emerald-600 uppercase tracking-tight whitespace-nowrap">
                                Giá bán lẻ niêm yết *
                              </Label>
                              <div className="relative">
                                <Input
                            ...
                            <div className="space-y-1.5">
                              <Label className="text-[10px] font-black text-orange-600 uppercase tracking-tight whitespace-nowrap">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-end">
                            <div className="space-y-1.5">
                              ...
                              />
                              {rowError?.initialStock && (
                                <p className="text-[9px] text-red-500 font-bold">
                                  {rowError.initialStock.message}
                                </p>
                              )}
                            </div>
                            ...
                            <div className="space-y-1.5">
                              ...
                              <div className="flex items-center gap-0">
                                <Input
                                  type="number"
                                  {...register(`variants.${idx}.netWeight`)}
                                  placeholder=""
                                  className="h-[34px] border-[#ccc] rounded-none rounded-r-none text-right text-[13px] shadow-none font-medium flex-1"
                                />
                                <Controller
                            ...
                            <div className="space-y-1.5">
                              ...
                              <Input
                                ...
                                placeholder=""
                                className="h-[34px] border-[#ccc] rounded-none text-right text-[13px] shadow-none font-medium"
                              />
                              {rowError?.shippingWeight && (
                                <p className="text-[9px] text-red-500 font-bold">
                                  {rowError.shippingWeight.message}
                                </p>
                              )}
                            </div>
                          </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="text-[11px] font-black text-slate-700 uppercase tracking-widest flex items-center gap-2">
                              ...
                              Thông số kỹ thuật đặc thù cho SKU #{idx + 1}
                            </span>
                          </div>
                          <button
                            type="button"
          ...
          <div className="bg-white border border-[#dcdcdc] rounded-none shadow-sm overflow-hidden">
            <div className="px-[20px] py-[12px] border-b border-[#eee] bg-[#f8f9fa] flex justify-between items-center">
              <h3 className="text-[11px] font-black text-slate-700 flex items-center gap-2 uppercase tracking-wider">
                <Settings2 size={16} className="text-blue-600" /> Bước 8: Quy
                đổi đơn vị sản phẩm
              </h3>
              <Button
                type="button"
            ...
            <div className="p-6 space-y-5">
              <div className="bg-blue-50/50 border border-blue-100 p-4 rounded-none">
                <p className="text-[11px] text-blue-800 leading-relaxed font-bold">
                  <span className="underline">Lưu ý nghiệp vụ:</span> Đơn vị quy
                  đổi không có tồn kho riêng mà phụ thuộc hoàn toàn vào đơn vị
                  gốc (đơn vị nhỏ nhất). Hệ thống sẽ tự động tính toán tồn kho
                  dựa trên tỷ lệ quy đổi.
                </p>
                <p className="text-[10px] text-blue-600 mt-2 italic font-medium">
                  Ví dụ: 1 Thùng = 12 Chai. Khi nhập hoặc bán 1 Thùng, kho Chai
                  sẽ tự động tăng/giảm tương ứng 12 đơn vị.
                </p>
              </div>
              ...
              {unitFields.length > 0 ? (
                <div className="space-y-5">
                  {unitFields.map((field, index) => (
                    <div
                      key={field.id}
                      className="bg-white border border-slate-200 rounded-none shadow-sm overflow-hidden group hover:border-blue-400 transition-all"
                    >
                      <div className="p-3 bg-slate-50/50 border-b border-slate-100 flex justify-between items-center">
                        <span className="text-[10px] font-black text-slate-500 uppercase tracking-widest">
                          Quy tắc quy đổi #{index + 1}
                        </span>
                        <button
                          type="button"
                      ...
                      <div className="p-5 space-y-5">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 items-end">
                          <div className="md:col-span-2 space-y-1.5">
                            ...
                            <Input
                              {...register(`unitConversions.${index}.fromUnit`)}
                              placeholder=""
                              className="h-[34px] text-[13px] border-[#ccc] rounded-none font-bold focus:border-blue-500"
                            />
                          </div>
                          ...
                          <div className="md:col-span-2 space-y-1.5">
                            ...
                            <Input
                              type="number"
                              {...register(`unitConversions.${index}.ratio`)}
                              className="h-[34px] text-[13px] border-[#ccc] rounded-none text-right font-black text-blue-600 focus:border-blue-500"
                            />
                          </div>
                          <div className="md:col-span-2 space-y-1.5">
                            <Label className="text-[10px] font-black text-slate-500 uppercase">
                            ...
                            <Input
                              {...register(`unitConversions.${index}.toUnit`)}
                              placeholder=""
                              className="h-[34px] text-[13px] border-[#ccc] rounded-none focus:border-blue-500"
                            />
                          </div>
                          <div className="md:col-span-2 space-y-1.5">
                            <Label className="text-[10px] font-black text-slate-500 uppercase">
                            ...
                            <div className="relative">
                              <Input
                                type="number"
                                {...register(`unitConversions.${index}.price`)}
                                className="h-[34px] text-[13px] border-[#ccc] rounded-none text-right pr-6 font-black text-emerald-600 shadow-inner focus:border-emerald-500"
                              />
                          ...
                          <div className="md:col-span-3 space-y-1.5">
                            ...
                            <div className="relative">
                              <Input
                                type="number"
                                {...register(
                                  `unitConversions.${index}.wholesalePrice`,
                                )}
                                className="h-[34px] text-[13px] border-[#ccc] rounded-none text-right pr-6 font-black text-orange-600 shadow-inner focus:border-orange-500"
                              />
                              <span className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-slate-300 font-bold">
                                ₫
                              </span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 pt-2 border-t border-slate-50">
                          <div className="space-y-1.5">
                            <Label className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">
                              Mã SKU (riêng cho đơn vị này)
                            </Label>
                            <Input
                              {...register(`unitConversions.${index}.sku`)}
                              placeholder=""
                              className="h-[34px] text-[12px] font-mono border-[#ccc] rounded-none focus:border-blue-500"
                            />
                          </div>
                          <div className="space-y-1.5">
                            <Label className="text-[10px] font-black text-slate-400 uppercase tracking-tighter">
                              Mã vạch / Barcode (riêng cho đơn vị này)
                            </Label>
                            <Input
                              {...register(`unitConversions.${index}.barcode`)}
                              placeholder=""
                              className="h-[34px] text-[12px] font-mono border-[#ccc] rounded-none focus:border-blue-500"
                            />
                          </div>
          ...
          <div className="bg-white border border-[#dcdcdc] p-6 rounded-none shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-3 mb-2">
              {mainImages.map((src, i) => (
                <div
                  key={i}
                  className="relative aspect-square border border-[#eee] rounded-none overflow-hidden group shadow-sm"
                >
              ...
              <div
                ...
                className="aspect-square border-2 border-dashed border-[#ddd] rounded-none flex flex-col items-center justify-center bg-[#fcfcfc] hover:bg-emerald-50 cursor-pointer shadow-inner transition-colors group"
              >
                <Upload
                  size={24}
            ...
            {errors.images && (
              <p className="text-[10px] text-red-500 font-bold text-center mt-3 tracking-tight">
      ...
      <div className="fixed bottom-0 left-0 lg:left-[260px] right-0 bg-[#f8f9fa] border-t border-[#ddd] p-[12px_30px] flex items-center justify-end gap-[15px] z-[999] shadow-[0_-4px_15px_rgba(0,0,0,0.05)]">
        ...
        <Button
          type="submit"
          className="min-w-[150px] h-[38px] text-[12px] font-black bg-emerald-600 hover:bg-emerald-700 text-white rounded-none shadow-md shadow-emerald-100 transition-all active:scale-[0.98] uppercase"
        >
