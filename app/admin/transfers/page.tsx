  ...
  return (
    <div className="space-y-4">
      <AdminPageHeader 
        ...
        tabs={[
          { id: "outbound", label: "Hàng Xuất (Gửi đi)", count: 12, color: "text-blue-600" },
          { id: "inbound", label: "Hàng Nhập (Sắp về)", count: 5, color: "text-orange-600" }
        ]}
        activeTab={activeTab}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
        <div className="bg-white border border-[#dcdcdc] p-4 flex items-center gap-4 shadow-sm">
          ...
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Đang vận chuyển</p>
        ...
        <div className="bg-white border border-[#dcdcdc] p-4 flex items-center gap-4 shadow-sm">
          ...
          <div>
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Giá trị hàng đi</p>
        ...
        {selectedIds.length > 0 ? (
          <div className="p-3 bg-slate-900 text-white flex items-center justify-between animate-in slide-in-from-top duration-300">
            <div className="flex items-center gap-4">
              <span className="text-[12px] font-black uppercase tracking-widest">Đã chọn {selectedIds.length} phiếu điều chuyển</span>
          ...
          <div className="p-3 bg-slate-50 border-b border-[#eee] flex flex-wrap items-center gap-3">
            <div className="relative flex-1 min-w-[250px]">
              ...
              <Input placeholder="Tìm mã phiếu, người chuyển, tài xế..." className="h-9 pl-10 text-[13px] border-slate-200 focus:border-blue-500 rounded-none shadow-none bg-white" />
            </div>
