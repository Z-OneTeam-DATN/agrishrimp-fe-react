...
import { BellRing, Search, RotateCw, Settings, Truck } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            size="sm"
            className="h-[32px] border-[#ddd] bg-white text-gray-500 font-semibold"
          >
          ...
          <Table className="table-custom">
            <TableHeader>
              <TableRow className="bg-[#f0f0f0] hover:bg-[#f0f0f0] border-b border-[#ccc]">
                ...
                <TableHead className="font-bold text-[#1f1f1f] text-[12px] uppercase p-[10px] whitespace-nowrap">
                  Mã yêu cầu
                </TableHead>
                <TableHead className="font-bold text-[#1f1f1f] text-[12px] uppercase p-[10px] whitespace-nowrap">
                  Đơn vị yêu cầu
                ...
                <TableHead className="text-right font-bold text-[#1f1f1f] text-[12px] uppercase p-[10px] whitespace-nowrap">
                  Số mặt hàng
                </TableHead>
                <TableHead className="font-bold text-[#1f1f1f] text-[12px] uppercase p-[10px] whitespace-nowrap text-center">
                  Độ ưu tiên
                </TableHead>
                <TableHead className="w-[150px] text-center font-bold text-[#1f1f1f] text-[12px] uppercase p-[10px] whitespace-nowrap">
                  Thao tác
                </TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {incomingRequests.map((req) => (
                ...
                >
                  ...
                  <TableCell className="p-[10px] text-[#007bff] font-bold">
                    {req.code}
                  </TableCell>
                  <TableCell className="p-[10px] text-[#1f1f1f] font-medium">
                    {req.from}
                  </TableCell>
                  ...
                  <TableCell className="p-[10px] text-center">
                    <Link href={`/admin/transfers/new?source=${req.code}`}>
                      <Button
                        variant="outline"
                        className="h-[28px] text-[11px] border-[#007bff] text-[#007bff] hover:bg-[#007bff] hover:text-white font-bold rounded-[4px] px-3"
                      >
                        Duyệt & Xuất kho
                      </Button>
                    </Link>
        ...
        <div className="flex items-center justify-between px-3 py-2 border-t border-[#eee] bg-[#f8f9fa]">
          ...
          <div className="flex items-center gap-1">
            <Button
              variant="outline"
              size="sm"
              className="h-[28px] px-2 text-[12px] bg-white border-[#ddd]"
            >
              Trước
            </Button>
            <Button
              variant="outline"
              size="sm"
              className="h-[28px] w-[28px] p-0 text-[12px] bg-[#007bff] text-white border-[#007bff]"
            >
              1
            </Button>
            <Button
