          ...
          <Table className="border-collapse">
            <TableHeader>
              <TableRow className="bg-[#5c7293] hover:bg-[#5c7293] border-b border-white/20">
                ...
                <TableHead colSpan={2} className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center bg-[#4a5d7a]">Xuất trong kỳ</TableHead>
                <TableHead colSpan={2} className="text-white font-bold text-[11px] uppercase text-center bg-[#4a5d7a]">Tồn cuối kỳ</TableHead>
              </TableRow>
              <TableRow className="bg-[#5c7293] hover:bg-[#5c7293]">
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[90px]">SL</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[120px]">Giá trị</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[90px]">SL</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[120px]">Giá trị</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[90px]">SL</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[120px]">Giá trị</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[90px]">SL</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase text-center w-[120px]">Giá trị</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
