          ...
          <Table className="border-collapse">
            <TableHeader>
              <TableRow className="bg-[#5c7293] hover:bg-[#5c7293]">
                ...
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[140px]">Định mức tối thiểu</TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase text-center w-[100px]">Thiếu hụt</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
