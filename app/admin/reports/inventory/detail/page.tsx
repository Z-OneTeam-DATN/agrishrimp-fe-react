          ...
          <Table className="border-collapse">
            <TableHeader>
              ...
              <TableRow className="bg-[#5c7293] hover:bg-[#5c7293] border-b border-white/20">
                ...
                <TableHead
                  rowSpan={2}
                  className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[250px]"
                >
                  Phiên bản sản phẩm
                </TableHead>
                <TableHead
              ...
              <TableRow className="bg-[#5c7293] hover:bg-[#5c7293]">
                ...
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[120px]">
                  Đang giao dịch
                </TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[120px]">
                  Hàng đang về
                </TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase text-center w-[120px]">
                  Hàng đang giao
                </TableHead>
              </TableRow>
            </TableHeader>
