...
export default function SupplierDetailPage() {
    ...
    useEffect(() => {
        const initData = async () => {
            ...
            try {
                ...
                if (supplierInfo) {
                    const rawPayment = supplierInfo.paymentTerm || supplierInfo.paymentTerm || "";
                    const safePayment = rawPayment.toLowerCase().replace("_", "");

                    reset({
                        ...supplierInfo,
                        category: supplierInfo.category?.id?.toString(),
                        status: supplierInfo.status?.toLowerCase() as SupplierFormValues["status"],
                        paymentTerms: safePayment as SupplierFormValues["paymentTerms"],
    ...
    const onError = (errors: any) => {
        console.error("LỖI VALIDATE TRANG SỬA:", errors);
                            ...
                            <div className="bg-white border border-[#dcdcdc] rounded-[4px] shadow-sm p-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <Input
                                            {...register("creditLimit", { valueAsNumber: true })} // 👇 Ép kiểu Number
                                            type="number"
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <Input
                                            {...register("discount", { valueAsNumber: true })} // 👇 Ép kiểu Number
                                            type="number"
                                            className="h-[30px] text-[12px]"
                                        />
                                        {errors.discount && (
