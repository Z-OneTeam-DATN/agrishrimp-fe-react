...
export default function ProfitLossReportPage() {
  ...
  const reportRows = [
    ...
    {
      id: "1",
      label: "1. Tiền hàng thực bán (1a - 1b)",
      prev: 0,
      current: 0,
      change: "0%",
      padding: "pl-8",
    ...
    {
      id: "II",
      label: "II. Chi phí bán hàng (1 + 2 + 3)",
      prev: 0,
      current: 0,
      change: "0%",
      isBold: true,
    ...
    {
      id: "II-1",
      label: "1. Chi phí giá vốn hàng hóa",
      prev: 0,
      current: 0,
      change: "0%",
      padding: "pl-8",
    ...
    {
      id: "III-1",
      label: "1. Phiếu thu khác hạch toán kết quả kinh doanh",
      prev: 0,
      current: 0,
      change: "0%",
      padding: "pl-8",
    ...
    {
      id: "IV-1",
      label: "1. Phiếu chi khác hạch toán kết quả kinh doanh",
      prev: 0,
      current: 0,
      change: "0%",
      padding: "pl-8",
              ...
              <TableRow className="bg-[#5c7293] hover:bg-[#5c7293] h-12">
                ...
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[20%]">
                  ...
                  <p className="text-[9px] font-medium opacity-80">
                    (10/12/2025 - 10/01/2026)
                  </p>
                </TableHead>
                <TableHead className="text-white font-bold text-[11px] uppercase border-r border-white/10 text-center w-[20%]">
                  <p>Kỳ hiện tại</p>
                  <p className="text-[9px] font-medium opacity-80">
                    (11/01/2026 - 11/02/2026)
                  </p>
                </TableHead>
              ...
              {reportRows.map((row) => (
                <TableRow
                  ...
                  className={cn(
                    ...
                    row.isResult &&
                      "bg-blue-50/50 hover:bg-blue-50 border-t-2 border-t-blue-100",
                  )}
                >
                  <TableCell
                    className={cn(
