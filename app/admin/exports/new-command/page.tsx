    ...
    <div className="space-y-4 pb-[100px] bg-slate-50/30 p-4 min-h-screen">
      ...
      <div className="flex items-center gap-4 mb-2 px-1">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-[11px] text-slate-400 font-bold uppercase tracking-wider">
            Phiếu mới: LXK-{new Date().getFullYear()}
            {new Date().getMonth() + 1}-001
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-x-6 gap-y-5">
              ...
              <div className="md:col-span-6 space-y-1.5">
                ...
                <Input
                  disabled
                  value="LXK-2602-001"
                  className="h-[34px] border-[#ccc] rounded-none bg-slate-50 font-mono"
                />
              </div>
              <div className="md:col-span-12 space-y-1.5">
                ...
                <Textarea
                  ...
                  className="min-h-[80px] text-[13px] border-[#ccc] rounded-none focus:border-blue-500 shadow-none resize-none"
                />
              </div>
              <div className="md:col-span-6 space-y-1.5">
                <Label className="text-[10px] font-black text-slate-500 uppercase tracking-tight">
                  Tham chiếu (Mã đơn hàng, Hợp đồng...)
                </Label>
                <Input
                  className="h-[34px] border-[#ccc] rounded-none focus:border-blue-500"
          ...
          <div className="bg-white border border-[#dcdcdc] rounded-none shadow-sm overflow-hidden">
            <div className="px-5 py-3 border-b border-[#eee] bg-[#f8f9fa] flex flex-wrap items-center justify-between gap-4">
              <h3 className="text-[11px] font-black text-slate-700 uppercase flex items-center gap-2 tracking-wider whitespace-nowrap">
                <ShoppingBag size={16} className="text-blue-600" /> 2. Danh mục
                sản phẩm xuất kho
              </h3>
              ...
              <div className="flex flex-1 items-center gap-2 min-w-[300px] max-w-[500px]">
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="h-9 text-[12px] border-slate-200 rounded-none px-3 font-bold text-slate-600"
                >
              ...
              <Table className="table-custom border-collapse min-w-[1000px]">
                <TableHeader>
                  <TableRow className="bg-slate-50 border-b border-[#ccc]">
                    ...
                    <TableHead className="w-[120px] text-right p-2 text-[10px] font-black uppercase text-blue-600">
                      SL Yêu cầu
                    </TableHead>
                    <TableHead className="w-[120px] text-right p-2 text-[10px] font-black uppercase text-slate-500">
                      Đơn giá
                    </TableHead>
                ...
                <TableBody>
                  {items.map((item, index) => (
                    ...
                    >
                      ...
                      <TableCell className="p-2 font-mono text-[12px]">
                        {item.sku}
                      </TableCell>
                      <TableCell className="p-2 font-bold text-[13px] text-slate-700">
                        {item.name}
                      </TableCell>
                      <TableCell className="p-2 text-center text-[12px] text-slate-500">
                        {item.unit}
                      </TableCell>
                      <TableCell className="p-2 text-right font-bold text-slate-500">
                        {item.stock}
                      </TableCell>
                      ...
                      <TableCell className="p-2 text-right text-[12px] font-medium">
            ...
            {items.length === 0 && (
              <div className="py-16 flex flex-col items-center justify-center bg-white space-y-4">
                ...
                <p className="text-[13px] font-black text-slate-400 uppercase tracking-widest text-center">
        ...
        <div className="lg:col-span-4 space-y-5">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] font-black text-slate-400 uppercase flex items-center gap-2">
                  <Building2 size={12} /> Chi nhánh xuất
                </Label>
              ...
              <div className="space-y-1.5">
                ...
                <Textarea
                  ...
                  className="min-h-[60px] text-[12px] border-[#ccc] rounded-none bg-slate-50/50 resize-none"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-[#dcdcdc] p-6 rounded-none shadow-sm space-y-6">
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-4 text-slate-700 font-black text-[11px] uppercase tracking-widest border-b pb-2">
                <UserCheck size={16} className="text-emerald-600" /> Đối tượng
                nhận hàng
              </div>
              ...
              {exportType === "SELL" && (
                <div className="space-y-1.5 animate-in fade-in slide-in-from-top-1 duration-300">
                  ...
                  <Select defaultValue="kh-01">
                    ...
                    <SelectContent className="rounded-none">
                      <SelectItem value="kh-01">
                        LÊ VĂN CHÂU (KH0012)
                      </SelectItem>
                      <SelectItem value="kh-02">
                        NGUYỄN THỊ MAI (KH0045)
                      </SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              ...
              {exportType === "INTERNAL" && (
                <div className="space-y-1.5 animate-in fade-in slide-in-from-top-1 duration-300">
                  <Label className="text-[10px] font-black text-slate-400 uppercase flex items-center gap-2">
                    <Users size={12} /> Nhân viên / Phòng ban
                  </Label>
              ...
              {exportType !== "WASTE" && (
                <>
                  <div className="space-y-1.5">
                    <Label className="text-[10px] font-black text-slate-500 uppercase tracking-tight flex items-center gap-2">
                      <User size={12} className="text-blue-500" /> Người nhận cụ
                      thể
                    </Label>
                    <Input
                      className="h-8 text-[12px] border-[#ccc] rounded-none focus:border-blue-500"
                      placeholder="Tên người nhận..."
                    />
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-[10px] font-black text-slate-500 uppercase tracking-tight flex items-center gap-2">
                      <MapPin size={12} className="text-emerald-500" /> Địa chỉ
                      giao hàng
                    </Label>
                    <Textarea
                      placeholder="Địa chỉ chi tiết..."
                      className="min-h-[60px] text-[12px] border-[#ccc] rounded-none focus:border-blue-500 resize-none bg-white"
                    />
                  </div>
                </>
              )}
              ...
              {exportType === "WASTE" && (
                <div className="p-4 bg-rose-50 border border-rose-100 text-rose-700 rounded-none flex gap-3 animate-in fade-in duration-300">
                  ...
                  <p className="text-[11px] leading-relaxed font-bold italic">
                    Lưu ý: Xuất hủy sẽ thực hiện giảm tồn ngay lập tức sau khi
                    duyệt mà không cần đối tượng nhận.
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="p-5 bg-amber-50 border border-amber-100 rounded-none flex gap-3">
            ...
            <p className="text-[11px] text-amber-700 leading-relaxed font-bold italic uppercase tracking-tighter">
              Lưu ý: Sau khi bấm "Tạo lệnh", chứng từ sẽ ở trạng thái Chờ thực
              hiện.
            </p>
          </div>
        </div>
      ...
      <div className="fixed bottom-0 left-0 lg:left-[260px] right-0 bg-[#f8f9fa] border-t border-[#ddd] p-[12px_30px] flex items-center justify-end gap-[15px] z-[999] shadow-[0_-4px_15px_rgba(0,0,0,0.05)]">
        ...
        <Button
          type="button"
          variant="outline"
          className="min-w-[140px] h-[38px] text-[12px] font-bold border-[#ccc] bg-white rounded-none uppercase hover:bg-slate-50"
        >
          LƯU NHÁP
        </Button>
        <Button
