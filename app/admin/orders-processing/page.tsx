...
const MOCK_PROCESSING_ORDERS = [
  {
    id: "#1005",
    createdDate: "14/02/2026 09:30",
    customer: {
      name: "Đại lý Thức ăn Thủy sản Ba Tuấn",
      phone: "0912345678",
      address: "Khóm 2, Thị trấn Đầm Dơi, Huyện Đầm Dơi, Cà Mau"
    },
    totalAmount: "15.400.000đ",
    paymentStatus: "Đã thanh toán",
    processingStatus: "Đang xử lý",
    shippingService: "Giao hàng tiết kiệm",
    note: "Khách cần hóa đơn VAT",
    tags: "Đại lý cấp 1",
    products: [
      {
        id: 101,
        name: "Men vi sinh xử lý đáy ao BZT (Gói 227g)",
        image: "https://images.unsplash.com/photo-1584017911766-d451b3d0e843?auto=format&fit=crop&q=80&w=100&h=100",
        quantity: 50,
        price: "120.000đ",
        total: "6.000.000đ"
      },
      {
        id: 102,
        name: "Khoáng tạt Canxi Magie (Bao 10kg)",
        image: "https://images.unsplash.com/photo-1615485290382-441e4d049cb5?auto=format&fit=crop&q=80&w=100&h=100",
        quantity: 20,
        price: "470.000đ",
        total: "9.400.000đ"
      }
  ...
  {
    id: "#1006",
    createdDate: "14/02/2026 10:15",
    customer: {
      name: "Hợp tác xã Nuôi tôm Công nghệ cao",
      phone: "0909009009",
      address: "Xã Vĩnh Hậu A, Huyện Hòa Bình, Bạc Liêu"
    },
    totalAmount: "2.850.000đ",
    ...
    products: [
      {
        id: 205,
        name: "Bộ Test Kit môi trường Sera (9 chỉ tiêu)",
        image: "https://images.unsplash.com/photo-1579165466741-7f35a4755657?auto=format&fit=crop&q=80&w=100&h=100",
        quantity: 1,
        price: "2.500.000đ",
        total: "2.500.000đ"
      },
      {
        id: 206,
        name: "Vó tôm (Nhà chài) 1m2",
        image: "https://images.unsplash.com/photo-1517424458928-8b9eb5e5746f?auto=format&fit=crop&q=80&w=100&h=100",
        quantity: 5,
        price: "70.000đ",
        total: "350.000đ"
      }
    ...
    <div className="p-4 space-y-4 bg-slate-50 min-h-screen">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <h1 className="text-[18px] font-bold text-slate-800">
          Chờ xử lý: <span className="font-normal text-slate-600">Cửa hàng chính</span>
        </h1>
      ...
      <div className="bg-white p-3 rounded-[4px] border border-[#dcdcdc] shadow-sm space-y-3">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <FilterButton label="Kho xuất hàng" />
        </div>
      </div>
      ...
      <div className="bg-white rounded-[4px] border border-[#dcdcdc] shadow-sm overflow-hidden">
        ...
        <div className="w-full overflow-x-auto">
          <Table>
            ...
            <TableBody>
              {MOCK_PROCESSING_ORDERS.map((order) => {
                        ...
                        <TableCell colSpan={9} className="p-0 border-b border-blue-100">
                          <div className="flex flex-col md:flex-row p-4 gap-6">
                            ...
                            <div className="w-full md:w-[30%] space-y-4 border-r border-slate-200 pr-6">
                              ...
                              <div className="border-t border-slate-100 pt-3">
                                <h3 className="text-[12px] font-bold text-slate-800 mb-1">Phân loại</h3>
                            ...
                            <div className="flex-1">
                                <div className="flex justify-between items-center mb-3">
                                    <h3 className="text-[12px] font-bold text-slate-800">Sản phẩm cần xử lý</h3>
                                    <div className="flex gap-2">
                                        <Button size="sm" variant="outline" className="h-[28px] text-[12px] font-bold border-slate-300">
                                            <Printer size={14} className="mr-1.5" /> In phiếu xuất
                                        </Button>
                                        <Button size="sm" className="h-[28px] bg-blue-600 hover:bg-blue-700 text-white text-[12px] font-bold">
                                            <PackageCheck size={14} className="mr-1.5" /> Duyệt đóng gói
                                        </Button>
                                        <Button size="sm" className="h-[28px] bg-emerald-600 hover:bg-emerald-700 text-white text-[12px] font-bold">
                                            <Truck size={14} className="mr-1.5" /> Đẩy vận chuyển
                                        </Button>
                                    </div>
                                </div>
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t border-[#eee] bg-white">
          <span className="text-[12px] text-slate-500 font-medium">
            Từ 1 đến {MOCK_PROCESSING_ORDERS.length} trên tổng {MOCK_PROCESSING_ORDERS.length}
          </span>
...
const StatusBadge = ({ status, type }: { status: string, type: 'payment' | 'processing' }) => {
    ...
    if (status === "Đang xử lý") styles = "bg-[#e6f7ff] text-[#1890ff] border-[#91d5ff]";
