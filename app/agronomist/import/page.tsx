    ...
    <div className="space-y-6">
      <section className="rounded-[28px] border border-[#d6ded5] bg-white p-6 shadow-sm">
        <div className="flex items-start gap-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#e7f0e9]">
            <FileSpreadsheet className="h-5 w-5 text-[#325b48]" />
          </div>
          <div>
            <p className="text-[12px] font-black uppercase tracking-[0.34em] text-[#7b8c80]">Excel Knowledge Import</p>
            <h3 className="mt-2 text-2xl font-black text-[#203126]">Nạp tri thức hàng loạt bằng Excel</h3>
        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-[1.2fr,0.8fr]">
          <div className="rounded-[24px] border border-dashed border-[#c8d5ca] bg-[#f7faf7] p-5">
            ...
            <input
              ...
              className="mt-4 block w-full rounded-2xl border border-[#d7dfd8] bg-white px-4 py-3 text-sm"
            />
            {file ? (
              <div className="mt-4 rounded-2xl border border-[#d7dfd8] bg-white px-4 py-3 text-sm text-slate-700">
                {file.name}
              </div>
            ) : null}
          </div>

          <div className="rounded-[24px] border border-[#dfe6dd] bg-white p-5">
            ...
            <select
              ...
              className="mt-4 h-12 w-full rounded-2xl border border-[#d7dfd8] bg-white px-4 text-sm text-slate-800 outline-none"
            >
      ...
      {preview ? (
        <section className="rounded-[28px] border border-[#d6ded5] bg-white p-6 shadow-sm">
          ...
          <div className="mt-6 overflow-hidden rounded-[24px] border border-[#dfe6dd]">
            <div className="grid grid-cols-[100px,120px,180px,1fr,1fr] bg-[#f3f7f3] px-4 py-3 text-[11px] font-black uppercase tracking-[0.24em] text-[#6f8174]">
              <div>Dòng</div>
              <div>Loại</div>
              <div>Mã</div>
              <div>Tên</div>
            ...
            {preview.rows.map((row) => (
              <div
                ...
                className="grid grid-cols-[100px,120px,180px,1fr,1fr] items-start gap-3 border-t border-[#eef2ee] px-4 py-4 text-sm"
              >
...
function Stat({ label, value }: { label: string; value: string | number }) {
  return (
    <div className="rounded-[24px] border border-[#dfe6dd] bg-[#f8fbf8] p-5">
      <p className="text-[12px] font-black uppercase tracking-[0.24em] text-[#7a8a7c]">{label}</p>
      <p className="mt-3 text-3xl font-black text-[#203126]">{value}</p>
    </div>
  );
}

const primaryButtonClassName =
  "inline-flex items-center justify-center gap-2 rounded-2xl bg-[#2f4e3f] px-4 py-3 text-sm font-bold text-white transition-colors hover:bg-[#274338]";
const secondaryButtonClassName =
  "inline-flex items-center justify-center gap-2 rounded-2xl border border-[#d2ddd3] bg-white px-4 py-3 text-sm font-semibold text-slate-700 transition-colors hover:bg-[#f4f7f4] disabled:cursor-not-allowed disabled:opacity-60";
const downloadButtonClassName =
  "inline-flex items-center justify-center gap-2 rounded-2xl border border-[#c9d7cb] bg-[#f5f9f5] px-4 py-3 text-sm font-semibold text-[#2f4e3f] transition-colors hover:bg-[#eef5ee]";
