...
const TRENDING_PRODUCTS = [
  { id: 6, name: 'Máy đo pH cầm tay Hanna', price: '1.200.000 ₫', image: 'https://apanano.com/wp-content/uploads/APA-MINER-POX_Shrimp.jpg', category: 'Thiết bị', reviewCount: 58, tag: 'HOT' as const },
  { id: 7, name: 'Kháng sinh thảo dược Gan Tụy', price: '220.000 ₫', image: 'https://apanano.com/wp-content/uploads/APA-MINER-POX_Shrimp.jpg', category: 'Thuốc trị bệnh', reviewCount: 12, tag: 'HOT' as const },
  { id: 8, name: 'Máy đo Oxy hòa tan kỹ thuật số', price: '3.500.000 ₫', image: 'https://apanano.com/wp-content/uploads/APA-MINER-POX_Shrimp.jpg', category: 'Thiết bị', reviewCount: 5, tag: 'HOT' as const },
  { id: 9, name: 'Men tiêu hóa đường ruột', price: '180.000 ₫', image: 'https://apanano.com/wp-content/uploads/APA-MINER-POX_Shrimp.jpg', category: 'Dinh dưỡng', reviewCount: 89, tag: 'HOT' as const },
  { id: 10, name: 'Lưới lan che nắng 70%', price: '45.000 ₫', image: 'https://apanano.com/wp-content/uploads/APA-MINER-POX_Shrimp.jpg', category: 'Vật tư', reviewCount: 200, tag: null },
];
