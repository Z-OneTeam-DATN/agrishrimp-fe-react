          ...
          <div className="lg:col-span-9">
            <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100">
              ...
              <div className="space-y-6 text-gray-700 text-sm md:text-base leading-relaxed">
                ...
                <div>
                  <p className="mb-4">
                    AgriShrimp miễn phí vận chuyển tại <strong className="text-gray-900">các tỉnh/thành phố có kho hàng hoặc đại lý của AgriShrimp</strong> (Xem <Link href="/store-locator" className="text-[#329965] font-bold hover:underline">Hệ thống cửa hàng AgriShrimp</Link>) cho các đơn hàng vật tư từ <strong className="text-red-600">90.000đ</strong> trở lên. Các đơn hàng dưới 90.000đ Quý khách/Bà con chỉ mất 10.000đ phí vận chuyển.
                  </p>
                  <p>
                    Đối với những khách hàng thuộc <strong className="text-gray-900">các tỉnh/thành phố KHÔNG có cửa hàng của AgriShrimp</strong> sẽ miễn phí vận chuyển đối với đơn hàng từ <strong className="text-red-600">249.000đ</strong> trở lên. Đơn hàng dưới 249.000đ có cước phí vận chuyển là 25.000đ.
                  </p>
                </div>
                ...
                <div className="overflow-hidden border border-gray-200 rounded-lg shadow-sm mt-6">
                  <table className="w-full text-left border-collapse">
                    <thead className="bg-gray-100 text-gray-700 text-xs uppercase font-bold">
                      <tr>
                        <th className="px-4 py-3 border-b border-r border-gray-200 w-2/5">Khu Vực</th>
                        <th className="px-4 py-3 border-b border-r border-gray-200 w-1/3">Điều kiện đơn hàng</th>
                        <th className="px-4 py-3 border-b border-gray-200 w-1/4">Phí vận chuyển</th>
                      </tr>
                    </thead>
                    <tbody className="text-sm divide-y divide-gray-200">
                      ...
                      <tr className="bg-white hover:bg-green-50/50 transition-colors">
                        <td rowSpan={2} className="px-4 py-4 border-r border-gray-200 align-top">
                ...
                <div className="flex items-start p-4 mt-6 bg-blue-50 border-l-4 border-blue-500 rounded-r text-blue-900 shadow-sm">
                   ...
                   <div>
                      ...
                      <p className="text-sm opacity-90">
                        Đối với các đơn hàng vật tư số lượng lớn (thức ăn bao, vôi, khoáng tạt...), phí vận chuyển có thể thay đổi tùy theo trọng lượng thực tế. Nhân viên sẽ liên hệ xác nhận cước phí trước khi giao hàng.
                      </p>
                   </div>
                </div>
