      ...
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100">
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-white uppercase bg-[#329965]">
              <tr>
                ...
                <th scope="col" className="px-6 py-4 w-[35%] text-center">
                  31 ngày trở đi
                </th>
              </tr>
            </thead>
              ...
              <tr className="bg-white hover:bg-gray-50">
                ...
                <td className="px-6 py-4 text-center text-gray-400">
                  ...
                  <div className="text-xs mt-1">
                    (Áp dụng bảo hành nếu là thiết bị)
                  </div>
                </td>
              </tr>
              <tr className="bg-white hover:bg-gray-50">
        ...
        <div className="flex items-start p-4 mb-8 text-blue-800 border-l-4 border-blue-600 bg-blue-50 rounded-r-lg">
          ...
          <div className="text-sm">
            <strong>Lưu ý:</strong> Từ ngày 01/01/2026, AgriShrimp áp dụng chính
            sách đổi trả mới trong vòng <strong>30 ngày</strong>.
          </div>
        </div>
        ...
        <div className="space-y-8 text-gray-700 text-sm md:text-base">
          ...
          <section>
            ...
            <ul className="list-disc pl-9 space-y-2 text-gray-600 marker:text-[#329965]">
              ...
              <li>
                Sản phẩm bị hư hỏng, trầy xước, đổ vỡ do quá trình vận chuyển
                của nhân viên giao hàng.
              </li>
              <li>Sản phẩm đã hết hoặc gần hết thời hạn sử dụng (Date).</li>
              <li>
                Sản phẩm không đúng yêu cầu: AgriShrimp soạn sai thuốc, giao
                nhầm loại, sai hàm lượng hoặc quy cách đóng gói.
              </li>
              <li>
                Sản phẩm còn nguyên vỏ hộp, tem nhãn và chưa qua sử dụng (đối
                với trường hợp khách đổi ý).
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-9 space-y-2 text-gray-600 marker:text-red-500">
              ...
              <li>
                Sản phẩm thuốc/thức ăn đã bị xé bao bì, mở nắp hoặc đã sử dụng
                xuống ao nuôi (trừ khi phát hiện lỗi chất lượng bên trong).
              </li>
              <li>
                Bao bì, vỏ hộp sản phẩm bị rách, nứt, hư hỏng do lỗi bảo quản từ
                phía khách hàng (để ngấm nước, chuột cắn...).
              </li>
          ...
          <section>
            ...
            <div className="pl-5 border-l-4 border-green-200 ml-2 space-y-3">
              ...
              <div>
                <p>
                  <strong>Bước 2:</strong> Gửi sản phẩm về AgriShrimp:
                </p>
                <ul className="list-disc pl-5 mt-1 text-gray-600">
                  <li>
                    <strong>Khách tại TP. Cần Thơ & lân cận:</strong> Khuyến
                    khích mang trực tiếp ra Cửa hàng/Kho để nhân viên kiểm tra
                    và đổi ngay sản phẩm mới.
                  </li>
                  <li>
                    <strong>Khách ở tỉnh xa:</strong> Gửi hàng qua bưu
                    điện/chành xe. Vui lòng liên hệ CSKH để lấy thông tin người
                    nhận và mã bưu điện.
                  </li>
                </ul>
              </div>
            ...
            <p className="mt-3 text-xs italic text-gray-500 pl-2">
              * Lưu ý: Khi đổi trả, quý khách vui lòng đem theo/gửi kèm quà tặng
              (nếu có) để được hỗ trợ trọn vẹn quy trình.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="mb-4 pl-2">
              <h6 className="font-bold text-gray-800 mb-2">
                a. Trả hàng trực tiếp tại Cửa hàng AgriShrimp
              </h6>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>Đơn thanh toán tiền mặt: Hoàn tiền mặt tại quầy.</li>
                <li>
                  Đơn thanh toán chuyển khoản/Thẻ: Hoàn tiền qua tài khoản ngân
                  hàng sau 3-5 ngày làm việc.
                </li>
                <li>
                  Đơn thanh toán qua VNPay/Ví điện tử: Hoàn về ví sau 3-8 ngày
                  làm việc.
                </li>
              </ul>
            </div>
            ...
            <div className="pl-2">
              <h6 className="font-bold text-gray-800 mb-2">
                b. Trả hàng qua đường bưu điện (Online)
              </h6>
              <ul className="list-disc pl-6 text-gray-600 space-y-1">
                <li>
                  Sau khi nhận được hàng trả về và kiểm tra đạt yêu cầu,
                  AgriShrimp sẽ chuyển khoản lại vào số tài khoản quý khách cung
                  cấp.
                </li>
                <li>
                  Đối với đơn hàng mua bằng Điểm tích lũy/Voucher: AgriShrimp sẽ
                  hoàn lại điểm hoặc cấp lại mã Voucher mới cho đơn hàng tiếp
                  theo.
                </li>
              </ul>
            </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mt-8 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 text-sm mb-2">
                Mọi thắc mắc và khiếu nại về đổi trả, bà con vui lòng liên hệ:
              </p>
