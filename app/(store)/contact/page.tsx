    ...
    <>
      ...
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100">
        ...
        <p className="text-gray-500 text-sm mb-8">
          Quý khách vui lòng gửi thắc mắc kỹ thuật, khiếu nại hoặc ý kiến đóng góp qua biểu mẫu bên dưới. Kỹ sư AgriShrimp sẽ phản hồi sớm nhất.
        </p>
          ...
          <div>
            {isSuccess && (
              <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-md flex items-center text-green-700 animate-fadeIn">
                ...
                <span className="text-sm font-medium">Gửi yêu cầu thành công! Chúng tôi sẽ liên hệ sớm nhất.</span>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              {/* Chi tiết */}
              <div>
                <label className="block text-sm font-bold text-gray-700 mb-1">Chi tiết <span className="text-red-500">*</span></label>
                <textarea 
                  {...register("content")}
                  rows={4} 
              ...
              <div key={index} className="border border-gray-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                <div className="bg-white p-6 flex items-center justify-center border-b border-gray-100 h-40">
                   <div className="text-[#329965] flex flex-col items-center opacity-50">
                     ...
                     <span className="text-xs mt-2 uppercase tracking-widest">Logo AgriShrimp</span>
                   </div>
                </div>
                <div className="bg-gray-50 p-4 text-center">
                  ...
                  <div className="inline-flex items-center text-sm font-bold text-gray-700 bg-white px-3 py-1 rounded-full border border-gray-200">
                    <Phone size={14} className="mr-2 text-[#329965]" /> 1800 6324
                  </div>
                </div>
              </div>
            ))}
