...
const DISTRICTS: Record<string, { value: string; label: string }[]> = {
  CT: [
    { value: "NK", label: "Q. Ninh Kiều" },
    { value: "CR", label: "Q. Cái Răng" },
  ],
  BL: [
    { value: "TPBL", label: "TP. Bạc Liêu" },
    { value: "HB", label: "H. Hòa Bình" },
  ],
  CM: [
    { value: "TPCM", label: "TP. Cà Mau" },
    { value: "UM", label: "H. U Minh" },
  ],
  ST: [
    { value: "TPST", label: "TP. Sóc Trăng" },
    { value: "TX", label: "TX. Vĩnh Châu" },
  ],
};
...
export default function StoreLocatorPage() {
  ...
  const [mapSrc, setMapSrc] = useState<string>(
    "https://maps.google.com/maps?q=10.029933,105.770615&hl=vi&z=14&output=embed",
  );
  ...
  const handleStoreClick = (store: Store) => {
    ...
    setMapSrc(
      `https://maps.google.com/maps?q=${store.lat},${store.lng}&hl=vi&z=14&output=embed`,
    );
