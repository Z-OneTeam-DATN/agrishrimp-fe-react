...
const BRANDS = [
  {
    name: "APA",
    logo: "https://apanano.com/wp-content/uploads/logo-apa.png",
    count: 120,
  },
  {
    name: "Bayer",
    logo: "https://www.bayer.com/themes/custom/bayer_c_and_i/logo.svg",
    count: 85,
  },
  {
    name: "CP Group",
    logo: "https://www.cpvietnam.com/Templates/images/logo.png",
    count: 150,
  },
  {
    name: "Thăng Long",
    logo: "https://thanglonginst.com/wp-content/uploads/2021/05/logo-thang-long.png",
    count: 90,
  },
  {
    name: "Grobest",
    logo: "https://www.grobest.com/uploads/allimg/210512/1-210512102119.png",
    count: 110,
  },
  {
    name: "Uni-President",
    logo: "https://www.uni-president.com.vn/images/logo.png",
    count: 70,
  },
];
            ...
            {BRANDS.map((brand, idx) => (
              ...
              >
                <div className="h-20 flex items-center justify-center mb-4">
                  {/* Logo placeholder */}
                  <div className="text-xl font-bold text-gray-400 group-hover:text-[#329965]">
                    {brand.name}
                  </div>
                </div>
