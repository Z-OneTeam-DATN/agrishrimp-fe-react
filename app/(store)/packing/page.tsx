...
const PACKING_STEPS = [
  {
    ...
    description: "Áp dụng cho các đơn hàng đi tỉnh, sử dụng đối tác giao hàng (Viettel Post, GHN...)."
  },
  {
    title: "2. Đối với đơn hàng giao bởi Shipper AgriShrimp",
    icon: User,
    image: "/images/donggoi2.png",
    description: "Áp dụng cho giao hàng hỏa tốc nội ô hoặc các khu vực lân cận kho hàng."
  },
  {
    title: "3. Tiêu chuẩn kiểm tra & Giao nhận",
    icon: ShieldCheck,
    image: "/images/donggoi3.png",
    description: "Cam kết minh bạch - Khách hàng luôn được đồng kiểm trước khi nhận."
  }
];
      ...
      <div className="bg-white p-6 md:p-8 rounded-lg shadow-sm border border-gray-100">
                ...
                <div className="mb-3 border border-gray-200 rounded-lg overflow-hidden shadow-sm">
                  ...
                  <div className="relative w-full h-[300px] md:h-[400px] bg-gray-50 flex items-center justify-center">
                     ...
                     <div className="absolute inset-0 flex items-center justify-center text-gray-400 bg-gray-100">
                        <span className="text-sm">Ảnh minh họa: {step.image}</span>
                          <Image 
                            src={step.image} 
                            alt={step.title}
                            fill
        ...
        <div className="mt-10 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r flex items-start">
          ...
          <div className="text-yellow-800 text-sm md:text-base">
            <p>
              Quý khách vui lòng <strong>TỪ CHỐI NHẬN HÀNG</strong> hoặc <strong>ĐỒNG KIỂM VỚI SHIPPER</strong> nếu phát hiện gói hàng có dấu hiệu bất thường, móp méo nghiêm trọng hoặc đóng gói không đúng quy cách như hình trên.
            </p>
          </div>
        </div>
