    ...
    <div className="bg-[#f8f9fa] min-h-screen pb-10 font-sans text-gray-800">
      <div className="container mx-auto px-4 py-6 max-w-5xl">
        <nav className="mb-4 text-sm flex items-center text-gray-500">
          ...
          <Link href="/orders/list" className="hover:text-[#2d9f8d]">
            Đơn hàng
          </Link>
          <span className="mx-2">/</span>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 mb-4">
          <div className="relative flex justify-between w-full px-4 mb-6">
            ...
            <div
              className="absolute top-[15px] left-10 h-1 bg-[#2d9f8d] -z-0 transition-all duration-500"
              style={{ width: "25%" }}
            ></div>
            ...
            {steps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`mt-2 text-xs font-bold ${isActive || isFinished ? "text-gray-900" : "text-gray-400"}`}
                  >
                    {step.label}
                  </div>
                  {step.time && (
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100 mb-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
            ...
            <div className="md:border-l md:pl-8 border-gray-100">
              ...
              <button className="mt-4 px-4 h-12 bg-[#2d9f8d] text-white text-sm font-bold rounded hover:bg-[#248273]">
                Thanh toán ngay
              </button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div className="divide-y divide-gray-100">
            {order.items.map((item, idx) => (
              <div key={idx} className="flex gap-4 p-4 items-center">
                ...
                <div className="text-center w-24 text-sm text-gray-600">
                  {item.unitPrice}
                </div>
                <div className="text-center w-16 text-sm text-gray-600">
                  x{item.quantity}
                </div>
                <div className="text-right w-24 font-bold text-sm text-gray-900">
                  {item.unitPrice}
                </div>
              </div>
            ))}
          ...
          <div className="bg-gray-50 p-4 space-y-2 border-t border-gray-100">
            <div className="flex justify-end text-base pt-2 border-t border-gray-200 mt-2">
              <span className="text-gray-800 font-bold w-40 text-right mr-4">
                Tổng thanh toán
              </span>
