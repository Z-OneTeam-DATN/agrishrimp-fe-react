        ...
        <form onSubmit={(e) => { e.preventDefault(); toast.success('Gửi yêu cầu thành công!'); router.push('/orders/return/list'); }}>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <div className="flex items-center gap-2 mb-4 font-bold text-gray-800"><ImageIcon className="text-red-500" size={20} /> 3. Bằng chứng hình ảnh</div>
                <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer bg-gray-50 hover:bg-[#f0fdfa] transition-colors">
                  ...
                  <p className="text-xs text-gray-500 font-semibold">Thêm hình ảnh lỗi</p>
