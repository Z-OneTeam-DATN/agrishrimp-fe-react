      ...
      return [
        {
          ...
          items: [
            {
              ...baseOrder.items[0],
              name: "Khoáng tạt APA Miner Pox giúp cứng vỏ",
              imageUrl:
                "https://apanano.com/wp-content/uploads/APA-MINER-POX_Shrimp.jpg",
              quantity: 5,
              unitPrice: 120000,
              displayUnitPrice: "120.000₫",
              variant: "Chai 1 lít",
            },
          ],
          displayTotalAmount: "600.000₫",
        },
      ] as Order[];
    case "CANCELLED":
      return [
        ...
        },
        {
          ...
          status: "CANCELLED",
          id: "ORD-CANCEL-02",
          displayTotalAmount: "120.000₫",
          items: [
            {
              ...baseOrder.items[0],
              name: "Khoáng tạt APA Miner Pox",
              imageUrl:
                "https://apanano.com/wp-content/uploads/APA-MINER-POX_Shrimp.jpg",
            },
          ],
        ...
        {isLoading ? (
          ...
          orders.map((order) => (
            <OrderCard
              key={order.id}
              order={order}
              onOrderCancelled={() => console.log("Reload list")}
            />
          ))
        ) : (
