...
import { ChevronRight, Phone, Mail, Lock, CheckCircle2 } from 'lucide-react';

export default function EditProfilePage() {
  const [showPasswordModal, setShowPasswordModal] = useState(false);

  // Dữ liệu giả lập (Lấy từ API thực tế của bạn)
  const userData = {
    ...
    <div className="bg-[#f8f9fa] min-h-screen pb-10 font-sans">
      <div className="container mx-auto px-4 py-6">
        ...
        <nav className="mb-6 text-sm text-gray-500 flex items-center">
          ...
          <ChevronRight size={14} className="mx-2" />
          <span className="font-bold text-gray-800">Thông tin tài khoản</span>
        </nav>
                  ...
                  <div className="mb-6 pb-6 border-b border-gray-100">
                    ...
                    <div className="flex justify-between items-center bg-gray-50 p-3 rounded-md border border-gray-100">
                      ...
                      <button 
                        ...
                        className="text-xs border border-gray-300 bg-white px-3 py-1.5 rounded hover:border-[#329965] hover:text-[#329965] transition-colors"
                      >
                        Cập nhật
                      </button>
                    </div>
