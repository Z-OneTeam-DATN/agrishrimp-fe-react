...
export default function EditProfilePage() {
  ...
  const userData = {
    ...
    avatarUrl:
      "https://hinhcute.net/wp-content/uploads/2025/06/httpswww.didongmy.comvnt_uploadnews05_2024anh-26-meme-dang-yeu-didongmy.jpg",
  };

  return (
    <>
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
        <h5 className="font-bold text-gray-800 text-lg mb-6 pb-3 border-b border-gray-100">
          Thông tin tài khoản
        </h5>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5">
            ...
            <div className="mb-6 pb-6 border-b border-gray-100">
              <div className="font-bold mb-4 text-sm text-gray-700 uppercase tracking-wide">
                Thông tin liên lạc
              </div>
              ...
              <div className="flex items-center justify-between p-3 border border-gray-200 rounded-md bg-white">
                <div className="flex items-center gap-2 font-medium text-sm text-gray-700">
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none">
                    ...
                    />
                    <path
                      d="M12.2401 24.0008C15.4766 24.0008 18.2059 22.9382 20.1945 21.1039L16.3275 18.1055C15.2517 18.8375 13.8627 19.252 12.2445 19.252C9.11388 19.252 6.45946 17.1399 5.50705 14.3003H1.5166V17.3912C3.55371 21.44 6.0166 24.0008 9.11388 24.0008H12.2401Z"
                      fill="#34A853"
                    />
                    <path
                      d="M5.50705 14.3003C5.24451 13.5133 5.10906 12.6732 5.10906 11.8106C5.10906 10.948 5.24451 10.1079 5.50705 9.32092V6.23004H1.5166C0.710729 7.89966 0.25415 9.80007 0.25415 11.8106C0.25415 13.8211 0.710729 15.7215 1.5166 17.3912L5.50705 14.3003Z"
                      fill="#FBBC05"
                    />
                    <path
                      d="M12.2445 4.36952C14.004 4.36952 15.5804 4.97507 16.8226 6.16007L20.2796 2.70308C18.2059 0.767969 15.4766 -0.379913 12.2445 -0.379913C9.11388 -0.379913 6.0166 2.18088 3.55371 6.23004L5.50705 9.32092C6.45946 6.48128 9.11388 4.36952 12.2445 4.36952Z"
                      fill="#EA4335"
                    />
                  </svg>
                  Google
