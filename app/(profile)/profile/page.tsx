    ...
    <div className="bg-[#f8f9fa] min-h-screen pb-10 font-sans">
      <div className="container mx-auto px-4 py-6">
        ...
        <nav className="mb-6 text-sm text-gray-500 flex items-center">
          ...
          <span className="font-bold text-gray-800">Tài khoản của tôi</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-3 hidden lg:block">
            {/* 👇 Component Sidebar dành riêng cho Profile */}
            <ProfileSidebar />
          </div>

          {/* CỘT PHẢI: NỘI DUNG CHÍNH (9 phần) */}
          <div className="lg:col-span-9">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-5 mb-6">
              <div className="flex justify-between items-center border-b border-gray-100 pb-3 mb-4">
                ...
                <Link href="/ordering" className="text-sm text-gray-500 hover:text-[#329965] flex items-center transition-colors group">
              ...
              <div className="grid grid-cols-5 gap-2 text-center">
                {/* Item 1: Đang xử lý */}
                <Link href="/ordering?status=processing" className="group flex flex-col items-center p-2 hover:bg-gray-50 rounded-lg transition-colors">
                ...
                {/* Item 2: Đang giao */}
                <Link href="/ordering?status=shipping" className="group flex flex-col items-center p-2 hover:bg-gray-50 rounded-lg transition-colors relative">
                ...
                {/* Item 3: Đã giao */}
                <Link href="/ordering?status=completed" className="group flex flex-col items-center p-2 hover:bg-gray-50 rounded-lg transition-colors">
                ...
                {/* Item 4: Hoàn trả */}
                <Link href="/return" className="group flex flex-col items-center p-2 hover:bg-gray-50 rounded-lg transition-colors">
                ...
                {/* Item 5: Đã hủy */}
                <Link href="/ordering?status=cancelled" className="group flex flex-col items-center p-2 hover:bg-gray-50 rounded-lg transition-colors">
              ...
              <div className="md:col-span-7">
                <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-5 h-full">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Link href="/account/edit" className="text-[#329965] text-sm flex items-center hover:underline">
              ...
              <div className="md:col-span-5">
                <div className="bg-white rounded-lg shadow-sm border border-gray-100 p-5 h-full flex flex-col">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <Link href="/account/address" className="text-[#329965] text-sm hover:underline">Quản lý</Link>
                  </div>
