      ...
      <div className="hidden lg:flex w-1/2 relative bg-zinc-900 overflow-hidden group">
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between p-12 text-white">
            <div className="flex items-center gap-5">
                <div className="relative group/logo cursor-default">
                    ...
                    <div className="relative w-14 h-14 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/30 flex items-center justify-center shadow-[0_0_15px_rgba(0,0,0,0.2)]">
                         <Image src="/images/logo_arishrimp.jpg" width={40} height={40} alt="Logo" className="rounded-xl object-cover w-full h-full p-0.5" />
                    </div>
                </div>
            ...
            <div className="mb-4 relative">
                ...
                <p className="text-teal-50/80 text-base max-w-lg leading-relaxed font-light border-l border-white/20 pl-6">"Người nuôi tôm thông minh không chỉ làm việc chăm chỉ, mà còn biết tận dụng công nghệ để bứt phá."</p>
                <div className="mt-8 flex gap-8 border-t border-white/10 pt-6">
                    <div><p className="text-xl font-bold text-white">2.5k+</p><p className="text-[10px] text-teal-200/60 uppercase tracking-widest font-semibold">Trang trại</p></div>
                    <div><p className="text-xl font-bold text-white">98%</p><p className="text-[10px] text-teal-200/60 uppercase tracking-widest font-semibold">Hài lòng</p></div>
                </div>
            </div>
            <div className="flex items-center gap-6 text-xs text-teal-200/50 font-medium tracking-wide"><span>© 2024 AGRISHRIMP INC.</span></div>
        </div>
      </div>
