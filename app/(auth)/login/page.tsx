        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-between p-12 text-white">
            ...
            <div className="mb-4 relative">
                ...
                <h2 className="text-4xl lg:text-[3rem] font-extrabold tracking-tight mb-4 leading-[1.1]">
                  Quản lý <br/>
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-200 via-white to-teal-200 animate-pulse-slow">
                    Hiệu quả & Bền vững
                  </span>
                </h2>
                
                <p className="text-teal-50/80 text-base max-w-lg leading-relaxed font-light border-l border-white/20 pl-6">
                  "Tham gia cùng cộng đồng AgriShrimp để tối ưu hóa quy trình nuôi trồng và gia tăng năng suất ngay hôm nay."
                </p>
                ...
                <div className="mt-8 flex gap-8 border-t border-white/10 pt-6">
                    <div>
                        ...
                        <p className="text-[10px] text-teal-200/60 uppercase tracking-widest font-semibold">Trang trại</p>
                    </div>
                    <div>
                        <p className="text-xl font-bold text-white">98%</p>
                        <p className="text-[10px] text-teal-200/60 uppercase tracking-widest font-semibold">Hài lòng</p>
                    </div>
                </div>
            </div>
        ...
        <div className="min-h-screen flex flex-col justify-center items-center py-6 px-6 lg:py-8">
            ...
            <div className="w-full max-w-[420px] relative z-10">
                ...
                <div className="mt-8 flex justify-center gap-6 text-xs text-slate-400 pb-4">
                    ...
                    <span className="text-slate-300">•</span>
                    <Link href="#" className="hover:text-teal-600 transition-colors">Trợ giúp</Link>
                </div>
            </div>
        </div>
      </div>
